...
The Helm chart is located in the [bcgov/nr-broker-credential-injection](https://github.com/bcgov/nr-broker-credential-injection/blob/main/provision-secret/README.md) repository.
